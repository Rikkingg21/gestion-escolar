@extends('layouts.app')
@section('title', 'Nueva Clase Virtual')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="bi bi-camera-video me-2"></i> Nueva Clase Virtual
                    </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('aula-virtual-docente.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="curso_grado_sec_niv_anio_id" id="curso_grado_sec_niv_anio_id"
                                    ...
                                    @foreach($cursos as $curso)
                                        <option value="{{ $curso->id }}" {{ old('curso_grado_sec_niv_anio_id') == $curso->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="plataforma" id="plataforma"
                                    ...
                                    <option value="meet" {{ old('plataforma') == 'meet' ? 'selected' : '' }}>Google Meet</option>
                                    <option value="zoom" {{ old('plataforma') == 'zoom' ? 'selected' : '' }}>Zoom</option>
                                    <option value="teams" {{ old('plataforma') == 'teams' ? 'selected' : '' }}>Microsoft Teams</option>
                                    <option value="otro" {{ old('plataforma') == 'otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                                @error('plataforma')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="estado" id="estado" class="form-select">
                                    <option value="1" {{ old('estado') == '1' || old('estado') === null ? 'selected' : '' }}>Activo</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="observaciones" id="observaciones" rows="2"
                                          class="form-control"
                                          placeholder="Materiales a llevar, indicaciones, etc. (opcional)">{{ old('observaciones') }}</textarea>
                                @error('observaciones')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-1"></i> Guardar Clase
                                </button>
                            </div>
                        </div>
                    </form>
