            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                        ...
                        <div id="campos-estudiante" class="campos-rol" style="display: none;">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="grado_id" class="form-label">Grado (solo activos)</label>
                        ...
                        <div id="campos-auxiliar" class="campos-rol" style="display: none;">
                            <div class="row">
                                <h5 class="mt-4 mb-3">Datos del Auxiliar</h5>
                                <div class="col-md-6">
                                    <label for="turno" class="form-label">Turno (Opcional)</label>
                                    <input type="text" class="form-control @error('turno') is-invalid @enderror" id="turno" name="turno" value="{{ old('turno') }}">
                                    @error('turno')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('funciones') is-invalid @enderror" id="funciones" name="funciones">{{ old('funciones') }}</textarea>
                                    @error('funciones')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
