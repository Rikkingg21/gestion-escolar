...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('mayas.create') }}" class="btn btn-primary shadow-sm">
                ...
                <table class="table table-bordered table-hover" id="materiasTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('bimestres.index', $maya->id) }}"
                                       class="btn btn-sm btn-info mx-1"
                                       title="Ver Detalles">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('mayas.edit', $maya->id) }}"
                                       class="btn btn-sm btn-warning mx-1"
                                       title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>

                                    <form action="{{ route('mayas.destroy', $maya->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
