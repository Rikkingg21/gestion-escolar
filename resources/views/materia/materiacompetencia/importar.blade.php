...
<div class="container-fluid">
    ...
    @if (session('duplicados') && count(session('duplicados')) > 0)
        <div class="alert alert-warning">
            <h6><i class="bi bi-exclamation-triangle me-2"></i>Competencias Duplicadas:</h6>
            <ul class="mb-0">
                    ...
                    <form action="{{ route('importar.competencia') }}" method="POST" enctype="multipart/form-data" id="importForm">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-success" id="btn-importar">
                                <i class="bi bi-upload me-2"></i> Importar Competencias
                            </button>
...
$(document).ready(function() {
    ...
    $('#importForm').on('submit', function() {
        ...
        return confirm('¿Estás seguro de que deseas importar las competencias?');
    });
});
</script>
@endpush
