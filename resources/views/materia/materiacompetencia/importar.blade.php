...
<div class="container-fluid">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-check-circle me-2"></i>Confirmar Importación de Competencias
                    </h5>
                </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="alert alert-success">
                                ...
                                <p class="text-center mb-0">competencias listas para importar</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <table class="table table-sm table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $registro['datos']['descripcion'] }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="modal-footer">
                    <form action="{{ route('importar.competencia') }}" method="POST" id="cancelForm">
                        @csrf
                    ...
                    <form action="{{ route('importar.competencia') }}" method="POST" id="procesarForm">
                        @csrf
                        <input type="hidden" name="accion" value="procesar">
                        <button type="submit" class="btn btn-success" onclick="mostrarPantallaCarga('Importando competencias...')">
                            <i class="bi bi-check-circle me-2"></i>Sí, Importar {{ session('registros_validos') }} Competencias
                        </button>
                    </form>
                </div>
            </div>
    ...
    <div id="messagesContainer">
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            @if(session('exitosos'))
            <br><small><strong>{{ session('exitosos') }}</strong> competencias importadas exitosamente.</small>
            @endif
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('importar.competencia') }}" method="POST" enctype="multipart/form-data" id="importForm">
                        @csrf
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                ...
                                <li><strong>Columna B:</strong> Nombre de la competencia (obligatorio)</li>
                                <li><strong>Columna C:</strong> Descripción (opcional)</li>
                            </ul>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <h5>Plantilla de Competencias</h5>
                        <p class="text-muted">Descarga la plantilla Excel con el formato correcto para importar competencias.</p>

                        <a href="{{ asset('templates/plantilla_materia_competencia.xlsx') }}" class="btn btn-info btn-block" download>
                            <i class="bi bi-download me-2"></i> Descargar Plantilla
                        </a>
                    </div>
                </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <i class="bi bi-exclamation-triangle text-warning me-2"></i>
                            No se permiten competencias duplicadas
                        </li>
                        <li class="mb-2">
                            <i class="bi bi-check-circle text-success me-2"></i>
