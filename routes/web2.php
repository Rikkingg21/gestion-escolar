...
Route::middleware('auth')->group(function () {
    ...
    // Rutas para Login As User / Switch Back
    Route::post('/loginas', [LoginController::class, 'loginAs'])->name('login.as');
    Route::post('/switchback', [LoginController::class, 'switchBack'])->name('login.switchback');
